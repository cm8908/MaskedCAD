...
class ConfigDropCLAE_MLM(object):
    ...
    def parse(self):
        ...
        parser.add_argument('--dataset_augment_type', type=str, default='default', choices=['default', 'replace', 'redraw', 'corrupt2'])
        ...
        parser.add_argument('--cl_loss', type=str, default='infonce', choices=['infonce', 'simclr'])
