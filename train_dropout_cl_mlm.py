...
from dataset.dropcl_mlm_dataset import get_dataloader
from config import ConfigDropCLAE_MLM
from utils import cycle
from trainer import TrainerDropoutCLAE_MLM
...
def main():
    ...
    cfg = ConfigDropCLAE_MLM('train')

    # create network and training agent
    # tr_agent = TrainerAE(cfg)
    tr_agent = TrainerDropoutCLAE_MLM(cfg)
